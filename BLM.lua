...
local sets = {
    ['MND_Priority'] = {
        ...
        Body = {'Errant Hpl.','Wzd. Coat +1','Bishop\'s Robe','Baron\'s Saio'},
		Neck = {'Faith Torque'},
        ...
        Ring1 = {'Aqua Ring','Saintly Ring +1'},
        Ring2 = {'Aqua Ring','Saintly Ring +1'},
        Back = {'White Cape +1','Mist Silk Cape'},
        Waist = {'Penitent\'s Rope','Reverend sash','Mrc.Cpt. Belt','Friar\'s Rope'},
		Legs = {'Mahatma Slops','Custom Pants'},
        Feet = {'Wzd. Sabots +1','Seer\'s Pumps +1'},
    },
    ['INT_Priority'] = {
        Main = {'Rose Wand +1','Solid Wand','Yew Wand +1'},
		--Sub = {'Yew Wand +1'},
        Ammo = {'Phtm. Tathlum','Morion Tathlum'},
        Head = {'Wzd. Petasos +1','Wizard\'s Petasos','Baron\'s Chapeau','Seer\'s Crown +1'},
		Neck = {'Prudence Torque','Checkered Scarf'},
        Ear1 = 'Abyssal Earring',
        Ear2 = 'Morion Earring',
        Body = {'Wzd. Coat +1','Baron\'s Saio'},
    ...
    ['Nuke_Priority'] = {
        ...
        Waist = {'Penitent\'s Rope','Reverend sash','Mrc.Cpt. Belt'},
		Legs = {'Mahatma Slops'},
        Feet = {'Sorcerer\'s Sabots','Custom F Boots','Seer\'s Pumps +1'},
    },
    ['SorcRing_Priority'] = {
        Ammo = {'Phtm. Tathlum','Morion Tathlum'},
        Head = {'Wzd. Petasos +1','Wizard\'s Petasos'},
		...
		Legs = 'Mahatma Slops',
        Feet = {'Sorcerer\'s Sabots','Custom F Boots'},
    },
    ['Enf_Priority'] = {
        Main = {'Rose Wand +1','Solid Wand','Yew Wand +1'},
		--Sub = {'Yew Wand +1'},
        ...
        Ring1 = {'Snow Ring','Eremite\'s Ring +1'},
        Ring2 = {'Snow Ring','Eremite\'s Ring +1'},
        Back = {'Altruistic Cape','Prism Cape','Black Cape +1'},
        Waist = {'Penitent\'s Rope','Reverend sash','Mrc.Cpt. Belt'},
		Legs = 'Igqira Lappas',
        Feet = {'Custom F Boots','Seer\'s Pumps +1'},
    },
    ['Enmity_Priority'] = {
		...
		Neck = {'Prudence Torque'},
        Ear1 = {'Geist Earring','Morion Earring','Energy Earring +1'},
        Ear2 = {'Magnetic earring','Geist Earring','Morion Earring','Energy Earring +1'},
        ...
        Waist = {'Penitent\'s Rope','Reverend sash','Mrc.Cpt. Belt','Friar\'s Rope'},
		Legs = {'Mahatma Slops','Custom Pants'},
        Feet = {'Sorcerer\'s sabots','Seer\'s Pumps +1'},
    },
    ['rest_Priority'] = {
        Main = {'Pluto\'s Staff','Pilgrim\'s Wand'},
        Body = {'Wzd. Coat +1','Vermillion Cloak','Seer\'s Tunic'},
		Head = 'Wzd. Petasos +1',
        Legs = 'Baron\'s Slops',
    ...
    ['idle_Priority'] = {
        ...
        Back = 'Hexerei Cape',
        Waist = 'Mrc.Cpt. Belt',
        Legs = {'Igqira lappas','Custom Pants'},
        Feet = {'Wzd. Sabots +1','Mountain Gaiters','Custom F Boots'},
    },
    ['SIRD_Priority'] = {
        Main = 'Hermit\'s Wand',
        ...
        Waist = 'Druid\'s Rope',
		Feet = {'Wzd. Sabots +1','Mountain Gaiters'},
		Ear2 = 'Magnetic Earring',
        Ear1 = 'Merman\'s Earring',
        Body = {'Igqira Weskit'},
        Hands = {'Merman\'s bangles','Seer\'s Mitts +1'},
...
profile.OnLoad = function()
	...
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind ^F6 /lac fwd Reraise');
	...
	--AshitaCore:GetChatManager():QueueCommand(-1, '/bind n /exec Count.txt');
end
...
profile.HandleDefault = function()
	...
	local totalmp = 750 - modmp;
	local totalmprest = 820 - modmp;
	...
	if (player.Status == 'Resting') then
		...
		if (Settings.Staticidle == false) then
				if (player.MP > (totalmprest + 0)) then gFunc.Equip('Hands','Zenith Mitts'); end --20
				if (player.MP > (totalmprest + 50 - 75)) then gFunc.Equip('Ammo','Hedgehog Bomb'); end --30
				if (player.MP > (totalmprest + 70 - 75)) then gFunc.Equip('Waist','Hierarch Belt'); end --48
				if (player.MP > (totalmprest + 118 - 100)) then gFunc.Equip('Ear2','Magnetic Earring'); end --20
				if (player.MP > (totalmprest + 138 - 125)) then gFunc.Equip('Back','Blue Cape +1'); end --40
				if (player.MP > (totalmprest + 170 - 125)) then gFunc.Equip('Feet','Rostrum pumps'); end --30
				if (player.MP > (totalmprest + 190 - 150)) then gFunc.Equip('Ring2','Serket Ring'); end --30
				if (player.MP > (totalmprest + 240 - 150)) then gFunc.Equip('Legs','Custom Pants'); end --32
			if (conquest:GetOutsideControl()) and (gData.GetBuffCount("signet") == 1) then	
				if (player.MP > (totalmprest + 272 - 175)) then gFunc.Equip('Neck','Rep.Gold Medal'); end --50
				if (player.MP > (totalmprest + 322 - 200)) then gFunc.Equip('Ear1','Loquac. Earring'); end --20
				if (player.MP > (totalmprest + 342 - 200)) then gFunc.Equip('Body','Wzd. Coat +1'); end --30
				if (player.MP > (totalmprest + 342 - 250)) then gFunc.Equip('Head','Faerie Hairpin'); end --55
			else	
				if (player.MP > (totalmprest + 272 - 160)) then gFunc.Equip('Neck','Uggalepih Pendant'); end --20
				if (player.MP > (totalmprest + 292 - 200)) then gFunc.Equip('Ear1','Loquac. Earring'); end --20
				if (player.MP > (totalmprest + 312 - 200)) then gFunc.Equip('Body','Wzd. Coat +1'); end --30
				if (player.MP > (totalmprest + 312 - 250)) then gFunc.Equip('Head','Faerie Hairpin'); end --55
			end	
		end
	end
	if (player.Status == 'Idle') then
		...
		if (Settings.Staticidle == false) then
				...
				if (player.MP > (totalmp + 190)) then gFunc.Equip('Ring2','serket ring'); end --30
				if (player.MP > (totalmp + 240)) then gFunc.Equip('Legs','Custom Pants'); end --32
			if (conquest:GetOutsideControl()) and (gData.GetBuffCount("signet") == 1) then	
				if (player.MP > (totalmp + 272)) then gFunc.Equip('Neck','Rep.Gold Medal'); end --50
				if (player.MP > (totalmp + 322)) then gFunc.Equip('Ear1','Loquac. Earring'); end --20
				if (player.MP > (totalmp + 342)) then gFunc.Equip('Body','Wzd. Coat +1'); end --30
				if (player.MP > (totalmp + 342)) then gFunc.Equip('Head','Faerie Hairpin'); end --55
			else	
				if (player.MP > (totalmp + 272)) then gFunc.Equip('Neck','Uggalepih Pendant'); end --20
				if (player.MP > (totalmp + 292)) then gFunc.Equip('Ear1','Loquac. Earring'); end --20
				if (player.MP > (totalmp + 312)) then gFunc.Equip('Body','Wzd. Coat +1'); end --30
				if (player.MP > (totalmp + 312)) then gFunc.Equip('Head','Faerie Hairpin'); end --55
			end	
		end
	end
...
profile.HandleItem = function()
 ...
 local sig = gData.GetBuffCount(matchBuff);
	...
	if (action.Name == 'Moval. Water') then
		 gFunc.EquipSet(sets.MaxMP);
		 gFunc.Equip('ring1','Astral Ring');
...
profile.HandleMidcast = function()
	...
	local Statbuffs = T{ 'Protect', 'Protect II', 'Shell', 'Shell II', 'Protectra', 'Protectra II', 'Shellra', 'Shellra II', 'Aquaveil',};
    local MndDebuffs = T{ 'Slow', 'Paralyze', 'Silence'};
    local ElementalDebuffs = T{ 'Burn', 'Rasp', 'Drown', 'Choke', 'Frost', 'Shock' };
	local Dynstat = T{'Avatar Icon', 'Effigy Prototype', 'Goblin Statue', 'Icon Prototype', 'Statue Prototype', 'Warchief Tombstone','Adamantking Effigy','Goblin Replica','Manifest Icon','Serjeant Tombstone'};
    local action = gData.GetAction();
	local sig = gData.GetBuffCount(matchBuff);
	...
	gFunc.InterimEquipSet(sets.SIRD);
			...
			if (player.MP > (totalmp + 190)) then gFunc.InterimEquip('Ring2','serket ring'); end --30
			if (player.MP > (totalmp + 240)) then gFunc.InterimEquip('Legs','Custom Pants'); end --32
		if (conquest:GetOutsideControl()) and (gData.GetBuffCount("signet") == 1) then	
			if (player.MP > (totalmp + 272)) then gFunc.InterimEquip('Neck','Rep.Gold Medal'); end --50
			if (player.MP > (totalmp + 322)) then gFunc.InterimEquip('Ear1','Loquac. Earring'); end --20
			if (player.MP > (totalmp + 342)) then gFunc.InterimEquip('Body','Wzd. Coat +1'); end --30
			if (player.MP > (totalmp + 342)) then gFunc.InterimEquip('Head','Faerie Hairpin'); end --55
		else	
			if (player.MP > (totalmp + 272)) then gFunc.InterimEquip('Neck','Uggalepih Pendant'); end --20
			if (player.MP > (totalmp + 292)) then gFunc.InterimEquip('Ear1','Loquac. Earring'); end --20
			if (player.MP > (totalmp + 312)) then gFunc.InterimEquip('Body','Wzd. Coat +1'); end --30
			if (player.MP > (totalmp + 312)) then gFunc.InterimEquip('Head','Faerie Hairpin'); end --55
		end	
	...
	elseif (action.Skill == 'Dark Magic') then
	    if string.match(zone.DayElement, "Dark") and (player.MainJobSync >= 65) and ((string.match(action.Name, 'Aspir') or string.match(action.Name, 'Drain'))) then
            gFunc.EquipSet(sets.MaxMP);
		...
		if string.match(action.Name, 'Stun') then
			gFunc.EquipSet(sets.Haste);
			if (player.MainJobSync >= 30) and (player.SubJob == 'RDM') then
				gFunc.Equip('back','Warlock\'s Mantle');
			end
	...
	if (Settings.Melee == true) then
		...
		if (player.HP > 737 ) and not (action.Skill == 'Elemental Magic') then
			...
			if (player.MP > (totalmp + 250)) then gFunc.Equip('Legs','Custom Pants'); end --32
		if (conquest:GetOutsideControl()) and (gData.GetBuffCount("signet") == 1) then	
			if (player.MP > (totalmp + 272)) then gFunc.Equip('Neck','Rep.Gold Medal'); end --50
			if (player.MP > (totalmp + 322)) then gFunc.Equip('Ear1','Loquac. Earring'); end --20
			if (player.MP > (totalmp + 342)) then gFunc.Equip('Body','Wzd. Coat +1'); end --30

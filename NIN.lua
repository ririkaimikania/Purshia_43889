...
profile.HandleMidcast = function()
	...
	if string.match(action.Name, 'Katon') or string.match(action.Name, 'Hyoton') or string.match(action.Name, 'Huton') or string.match(action.Name, 'Doton') or string.match(action.Name, 'Raiton') or string.match(action.Name, 'Suiton')then
